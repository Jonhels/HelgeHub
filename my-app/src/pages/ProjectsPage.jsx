...
const projects = [
  {
    ...
    technologies:
      "MongoDB, Express.js, React, Node.js, JWT, role-based access, PDF export.",
    myContributions:
    ...
    image:
      "https://cdn.sanity.io/images/9hf3wtbb/production/08d64520aee5dc1fd96627f12feb42733e7b4a6a-1068x719.png",
    imageCont: sup1,
    imageCont2: sup2,
    imageCont3: sup3,
  ...
  },
  {
    ...
    myContributions3:
      "For deployment, I used Railway to handle both backend and frontend pipelines, taking advantage of its ability to automatically deploy from GitHub commits. The build and deploy process is streamlined for continuous integration, ensuring that updates push live immediately after code is merged. The domain is connected with HTTPS and performance-optimized for fast loading. I also used tools like Lighthouse and web.dev to audit accessibility and speed, making several adjustments to improve Core Web Vitals scores. This makes the site reliable not only for users but also for SEO and potential employers browsing it. Additionally, I integrated GitHub's API to pull dynamic stats or repository previews, helping automate parts of the content pipeline.",
    image:
      "https://cdn.sanity.io/images/9hf3wtbb/production/32ba11bc948b44a00e8581e60c67dad0224bc0f6-1739x945.png",
    imageCont: port1,
    imageCont2: port2,
    imageCont3: port3,
